# CST Studio Suite 2025 - X-band dual-polarized 1-bit RRA unit cell.
...
# angles are registered with StoreParameter and referenced by CST geometry.
...
def main() -> None:
    ...
    print("Use four Parameter Sweep sequences to set Rx/Cx/Ry/Cy for 00/01/10/11.")
    if not RUN_SOLVER:
